...
const DialogItem = (props) => {
    return (
        <div 
            className={classNames('dialogs__item', {'dialogs__item--online' : differenceInMinutes(new Date(), new Date(props.user.last_seen)) < 5, 'dialogs__item--active' : props.currentDialogId === props.id})}
